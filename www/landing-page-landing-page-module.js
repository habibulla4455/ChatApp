...
/***/ "./src/app/landing-page/landing-page-provider.module.ts":
/*!**************************************************************!*\
  !*** ./src/app/landing-page/landing-page-provider.module.ts ***!
  \**************************************************************/
/*! exports provided: LandingPageProviderModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LandingPageProviderModule", function() { return LandingPageProviderModule; });
...
var LandingPageProviderModule = /** @class */ (function () {
    function LandingPageProviderModule() {
    }
    LandingPageProviderModule = __decorate([
    ...
    return LandingPageProviderModule;
}());
...
/* harmony import */ var _login_login_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./login/login.component */ "./src/app/landing-page/login/login.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    { path: '', component: _landing_page_component__WEBPACK_IMPORTED_MODULE_2__["LandingPageComponent"], children: [
...
/* harmony import */ var _landing_page_provider_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./landing-page-provider.module */ "./src/app/landing-page/landing-page-provider.module.ts");
...
/* harmony import */ var _login_login_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./login/login.component */ "./src/app/landing-page/login/login.component.ts");
/* harmony import */ var _landing_page_guard__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./landing-page.guard */ "./src/app/landing-page/landing-page.guard.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    LandingPageModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                ...
                _landing_page_provider_module__WEBPACK_IMPORTED_MODULE_3__["LandingPageProviderModule"]
            ],
            declarations: [
                _landing_page_component__WEBPACK_IMPORTED_MODULE_4__["LandingPageComponent"],
                _login_login_component__WEBPACK_IMPORTED_MODULE_5__["LoginComponent"]
            ],
            providers: [
                _landing_page_guard__WEBPACK_IMPORTED_MODULE_6__["LandingPageGuard"]
            ],
            schemas: [
...
/***/ "./src/app/landing-page/login/login.component.html":
/*!*********************************************************!*\
  !*** ./src/app/landing-page/login/login.component.html ***!
  \*********************************************************/
/*! no static exports found */
...
module.exports = "<div id=\"container\">\n\n  <mat-card>\n    <mat-card-content>\n\n      <div>\n        <p id=\"header\">Sign in</p>\n        <button mat-icon-button type=\"button\" [matMenuTriggerFor]=\"menu\"><mat-icon>more_vert</mat-icon></button>\n      </div>\n\n      <form (ngSubmit)=\"onSubmit()\" [formGroup]=\"loginForm\">\n        <mat-form-field color=\"accent\">\n          <mat-label>Email</mat-label>\n          <input matInput type=\"email\" formControlName=\"email\">\n          <mat-error *ngIf=\"loginForm.get('email').invalid\">This is required.</mat-error>\n        </mat-form-field>\n        <mat-form-field color=\"accent\">\n          <mat-label>Password</mat-label>\n          <input matInput type=\"password\" formControlName=\"password\">\n          <mat-error *ngIf=\"loginForm.get('password').invalid\">This is required.</mat-error>\n        </mat-form-field>\n\n        <button mat-raised-button>LOG IN</button>\n      </form>\n\n    </mat-card-content>\n    <mat-card-footer *ngIf=\"isSigningin\">\n      <mat-progress-bar mode=\"indeterminate\"></mat-progress-bar>\n    </mat-card-footer>\n  </mat-card>\n\n</div>\n\n<mat-menu #menu>\n  <button mat-menu-item (click)=\"onSigninAnonymously()\">\n    Sign in anonymously\n  </button>\n  <button mat-menu-item (click)=\"onCreateAccount()\">\n    Create an account\n  </button>\n</mat-menu>\n"

/***/ }),

/***/ "./src/app/landing-page/login/login.component.scss":
/*!*********************************************************!*\
  !*** ./src/app/landing-page/login/login.component.scss ***!
  \*********************************************************/
/*! no static exports found */
...
module.exports = "#container {\n  display: flex;\n  height: 100vh; }\n  #container .mat-card {\n    width: 80vw;\n    margin: 20vh auto auto;\n    padding-bottom: 0; }\n  #container .mat-card div {\n      display: flex; }\n  #container .mat-card div .mat-icon-button {\n        margin-left: auto; }\n  #container .mat-card #header {\n      font-size: 2em;\n      margin-bottom: 10px; }\n  #container .mat-card .mat-form-field {\n      width: 100%; }\n  #container .mat-card .mat-raised-button {\n      float: right;\n      margin-bottom: 24px; }\n"

/***/ }),

/***/ "./src/app/landing-page/login/login.component.ts":
/*!*******************************************************!*\
  !*** ./src/app/landing-page/login/login.component.ts ***!
  \*******************************************************/
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(fb, router, route, auth, firestore) {
        this.fb = fb;
        this.router = router;
        this.route = route;
        this.auth = auth;
    ...
    LoginComponent.prototype.onSigninAnonymously = function () {
    ...
    LoginComponent.prototype.onSubmit = function () {
        ...
        this.auth.signInWithEmailAndPassword(form.email, form.password)
            ...
            _this.firestore.setUserStatus(true, false);
            _this.router.navigate(['dashboard'], { relativeTo: _this.route });
        }).catch(function (e) {
            _this.isSigningin = false;
            _this.loginForm.reset();
            _this.loginForm.patchValue({ email: form.email });
            alert(e.message);
        });
    };
    LoginComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-login',
            template: __webpack_require__(/*! ./login.component.html */ "./src/app/landing-page/login/login.component.html"),
            styles: [__webpack_require__(/*! ./login.component.scss */ "./src/app/landing-page/login/login.component.scss")]
        }),
        ...
        __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], _common_core_services_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"], _common_core_services_firestore_service__WEBPACK_IMPORTED_MODULE_4__["FirestoreService"]])
    ], LoginComponent);
